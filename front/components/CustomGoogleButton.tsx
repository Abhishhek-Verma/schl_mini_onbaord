...
export function CustomGoogleButton({ onStart, onError }: CustomGoogleButtonProps) {
  ...
  return (
    <button
      ...
      onClick={() => googleLogin()}
      disabled={loading}
      className="inline-flex items-center justify-center gap-3 w-full px-4 py-3 bg-secondary hover:bg-secondary/80 text-secondary-foreground border border-border rounded-md text-sm font-semibold cursor-pointer transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
    >
